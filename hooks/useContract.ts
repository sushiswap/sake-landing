...
const SAKE_ADDRESS = "0xe9F84dE264E91529aF07Fa2C746e934397810334";
const SAKE_ABI = [
  {
    anonymous: false,
    inputs: [
...
export const BURNER_ADDRESS = "0x5744341e383d7981627280E9449EB4ae7E11Be50";
const BURNER_ABI = [
  {
    inputs: [
      { internalType: "address", name: "_sakeToken", type: "address" },
...
export function useSakeContract() {
